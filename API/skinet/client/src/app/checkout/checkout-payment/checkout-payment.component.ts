...
export class CheckoutPaymentComponent implements OnInit{
  ...
  ngOnInit(): void {
    loadStripe("pk_test_51MihfQSBjT6nGVJuaWtbD3MAbFp1YTcpzKK4hqz7xcvcXbdaTF2xm3a2E9SWGoFakJnLyjhWh6Ldgw3ACBHyTHOw00yaCARAE8")
      .then(stripe => {
        this.stripe = stripe;
  ...
  async submitOrder() {
    ...
    if (!basket) throw new Error('cannont get basket');
    try {
