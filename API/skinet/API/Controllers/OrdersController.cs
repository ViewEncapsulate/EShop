...
namespace API.Controllers
{
    ...
    public class OrdersController : BaseApiController
    {
        ...
        public async Task<ActionResult<Order>> CreateOrder(OrderDto orderDto)
        {
            ...
            var order = await this.orderService.CreateOrderAync(email, orderDto.DeliveryMethodId, orderDto.BasketId, address);
        ...
        {
            return Ok(await this.orderService.GetDeliveryMethodAsync());
        }
    }
}